...
class _FoodPageState extends State<FoodPage> {
  ...
  Widget build(BuildContext context) {
    final currentEntry = FoodRepositories().getFoodEntryById(widget.id);
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      FavoriteButton(foodEntry: currentEntry),
                    ],
                  ),
                  SizedBox(height: 4.0),
                  Row(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        context.read<CartCubit>().addCartItem(
                          CartItem(currentEntry),
                        );

                        messenger.showSnackBar(
                          SnackBar(
                            content: Text(
                              'Added ${currentEntry.title} to Cart',
                            ),
                          ),
                        );
                      },
